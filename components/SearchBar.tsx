...
const suggestions = [
    ...
    "Hey there! Could you share your recent activity search history with me?",
    "Hi! I'd love to see your latest search history for activities.",
    "Hello! Can you provide me with your recent requests for activity searches?",
];
